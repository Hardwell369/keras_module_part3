...
friendly_name = "RepeatVector - Keras"
doc_url = "https://keras.io/api/layers/reshaping_layers/repeat_vector/"
cacheable = False
...
def run(
    ...
    layer = keras.layers.RepeatVector(**init_params)(**call_params)
